...
public class BoxofficeApi {
	...
	public String getBoxoffice(String openDt) throws IOException {
		System.out.println("openDt 메서드 " + openDt);
...
//		System.out.println(today);
		StringBuilder urlBuilder = new StringBuilder("http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key="
                + serviceKey + "&targetDt=20200908&itemPerPage=10");
		urlBuilder.append("&" + URLEncoder.encode("openDt", "UTF-8") + "=" + openDt); // serviceKey
